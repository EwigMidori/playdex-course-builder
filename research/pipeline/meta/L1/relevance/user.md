  ...
  "step_assets": [
    {
      ...
      "question_bank_path": "research/pipeline/3-guided_story/L1/step1/question_bank.json",
      "question_families": [
        {
          "family_id": "qf_flash_algo_def",
      ...
      "step_path": "research/pipeline/3-guided_story/L1/step1/step.json"
    },
    {
      "question_bank": {
        "coverage_map": [
      ...
      "question_bank_path": "research/pipeline/3-guided_story/L1/step2/question_bank.json",
      "question_families": [
        {
          "family_id": "qf_flash_market_trend",
          "kind": "flashcard_families",
      ...
      "step_path": "research/pipeline/3-guided_story/L1/step2/step.json"
    },
    {
      "question_bank": {
        "coverage_map": [
      ...
      "question_bank_path": "research/pipeline/3-guided_story/L1/step3/question_bank.json",
      "question_families": [
        {
          "family_id": "qf_flash_order_book",
          "kind": "flashcard_families",
      ...
      "step_path": "research/pipeline/3-guided_story/L1/step3/step.json"
    },
    {
      "question_bank": {
        "coverage_map": [
      ...
      "question_bank_path": "research/pipeline/3-guided_story/L1/step4/question_bank.json",
      "question_families": [
        {
          "family_id": "qf_flash_long_short_def",
          "kind": "flashcard_families",
      ...
      "step_path": "research/pipeline/3-guided_story/L1/step4/step.json"
    },
    {
      "question_bank": {
        "coverage_map": [
      ...
      "question_bank_path": "research/pipeline/3-guided_story/L1/step5/question_bank.json",
      "question_families": [
        {
          "family_id": "qf_flash_leverage_margin",
          "kind": "flashcard_families",
      ...
      "step_path": "research/pipeline/3-guided_story/L1/step5/step.json"
    },
    {
      "question_bank": {
        "coverage_map": [
      ...
      "question_bank_path": "research/pipeline/3-guided_story/L1/step6/question_bank.json",
      "question_families": [
        {
          "family_id": "qf_flash_data_fuel",
          "kind": "flashcard_families",
      ...
      "step_path": "research/pipeline/3-guided_story/L1/step6/step.json"
    }
  ],
  "target_language": "zh-CN",
  "textbook": {
    ...
    "path": "research/pipeline/5-textbook/L1.mdx",
    "sections": [
      {
        "content": "",
        "level": 1,
      ...
      },
      {
        ...
        "title": "机器人交易 vs 机器人投顾"
      },
      {
        "content": "",
        "level": 2,
        "section_id": "section_9",
        "title": "交易机制与订单簿 {#trading-mechanism}"
      },
      {
        "content": "\n<Definition title=\"订单簿 (Order Book)\">\n实时更新的买卖订单列表，按价格排序。它是市场撮合交易的核心工具。\n</Definition>\n\n订单簿包含两方：\n- **买方队列（Bid Book）**：列出所有愿意买入的订单\n- **卖方队列（Ask Book）**：列出所有愿意卖出的订单\n",
        "level": 3,
      ...
      },
      {
        ...
        "title": "做多、做空与盈亏计算 {#positions-pnl}"
      },
      {
        "content": "\n<Definition title=\"多头头寸 (Long Position)\">\n先买入资产，预期价格上涨后卖出获利。\n</Definition>\n\n**操作步骤**：买入 → 等待价格上涨 → 卖出\n\n**最大风险**：损失全部本金（股价跌至0）\n",
        "level": 3,
      ...
      },
      {
        ...
        "title": "杠杆、保证金与交易系统 {#leverage-margin}"
      },
      {
        "content": "\n<Definition title=\"杠杆 (Leverage)\">\n使用借入资金来放大投资回报的方式。\n</Definition>\n\n<Formula latex=\"Leverage\\ Ratio = \\frac{Asset}{Equity}\">\n杠杆比率 = 资产总值 / 自有资金\n</Formula>\n",
        "level": 3,
      ...
      },
      {
        ...
        "title": "实施算法交易的基础设施 {#infrastructure}"
      },
      {
        "content": "\n<KeyPoint>\n没有数据，算法寸步难行。数据是算法交易的输入和决策依据。\n</KeyPoint>\n",
        "level": 3,
